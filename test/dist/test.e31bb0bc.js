...
},{"./defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js"}],"js/get-location.js":[function(require,module,exports) {
"use strict";
...
var GEOLOCATION_DEFAULT_OPTIONS = {
...
var getLocation = function getLocation() {
  ...
  var options = (0, _objectSpread2.default)({}, GEOLOCATION_DEFAULT_OPTIONS, opts);
  return new Promise(function (resolve, reject) {
...
},{"@babel/runtime/helpers/objectSpread":"node_modules/@babel/runtime/helpers/objectSpread.js"}],"js/fetch-weather.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _regenerator.default.mark(function _callee(_ref) {
    var latitude, longitude, response, weather;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return fetch("".concat(PROXY, "/https://api.darksky.net/forecast/769d98f8296ca9e8bbd3af36d8d98b73/").concat(latitude, ",").concat(longitude, "?units=si&lang=uk"));
...
var _getLocation = _interopRequireDefault(require("./js/get-location"));

var _fetchWeather = _interopRequireDefault(require("./js/fetch-weather"));
...
function () {
  ...
  _regenerator.default.mark(function _callee() {
    var location, weather, daily, daysInfo;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", console.log('Geolocation is not available in your browser!'));

          case 2:
            _context.prev = 2;
            _context.next = 5;
            return (0, _getLocation.default)();

          case 5:
            location = _context.sent;
            _context.next = 8;
            return (0, _fetchWeather.default)(location.coords);

          case 8:
            weather = _context.sent;
            daily = weather.daily.data;
            console.log(daily);
            daysInfo = daily.reduce(function (acc, _ref2) {// document.body.insertAdjacentElement('beforeend', `${summary}`);
